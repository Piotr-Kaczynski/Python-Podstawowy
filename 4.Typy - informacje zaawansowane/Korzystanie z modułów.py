...
# print(statistics.median(sorted(percent)), statistics.median_low(sorted(percent)), statistics.median_high(sorted(percent)))
print(median(sorted(percent)), median_low(sorted(percent)), median_high(sorted(percent)))